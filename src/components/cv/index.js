...
const Cv = () => {
    return (
        <div className={CvStyles.container} id="cv">
            ...
            <button className={CvStyles.button}><a href="https://www.linkedin.com/feed/update/urn:li:activity:6920453701321011200/" download="cv ingles.pdf">Ingles</a> Ingles </button>
